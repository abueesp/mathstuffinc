...
print "Hello, I'm the %scriptname, a pretty dumb code for easy testing of Mersenne primes (2^n-1). Take into account that if n is prime then 2^n-1 is prime too." % (scriptname)
